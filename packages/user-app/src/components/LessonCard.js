...
import {  LANGUAGES, LEVELS  } from '@dictaflow/shared';
...
export function renderLessonCard(lesson, onClick) {
  ...
  const card = h('div', {
    ...
    h('div', { 
      ...
      lesson.isVip ? h('div', { style: { position: 'absolute', top: '10px', left: '10px', background: 'linear-gradient(45deg, #ffd700, #ff8c00)', color: '#000', padding: '2px 8px', borderRadius: '4px', fontSize: '12px', fontWeight: 'bold', zIndex: 10 } }, '⭐ VIP') : null,
